...
buttonGridColumnFlow.addEventListener("click", () => {
    removeGrids()
    generateGridFlowColumnColumns()
})

buttonGridRowFlow.addEventListener("click", () => {
    removeGrids()
    generateGridFlowRowColumns()
})
